...
@Component({
  selector: 'app-update-leave-request-panel',
  templateUrl: './update-leave-request-panel.component.html',
  styleUrls: ['./update-leave-request-panel.component.scss']
})
export class UpdateLeaveRequestPanelComponent implements OnInit {
