...
@Component({
  selector: 'app-advance-payment-request-panel',
  templateUrl: './advance-payment-request-panel.component.html',
  styleUrls: ['./advance-payment-request-panel.component.scss']
})
export class AdvancePaymentRequestPanelComponent implements OnInit {
  ...
  _dataSource() {
    this.dataSource = new CustomStore({
      key: 'id',
      load: () => GridUtil.handleGridResponse(this.userPaymentService.getUserAdvancePayments()),
    });
  }
