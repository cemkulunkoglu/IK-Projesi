...
@Component({
  selector: 'app-spending-payment-request-panel',
  templateUrl: './spending-payment-request-panel.component.html',
  styleUrls: ['./spending-payment-request-panel.component.scss']
})
export class SpendingPaymentRequestPanelComponent implements OnInit {
  ...
  _dataSource() {
    this.dataSource = new CustomStore({
      key: 'id',
      load: () => GridUtil.handleGridResponse(this.userPaymentService.getUserSpendingPayments()),
    });
  }
