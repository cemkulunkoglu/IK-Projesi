...
import { LeaveRequestPanelComponent } from './leave-request-panel/leave-request-panel.component';
...
import { LeaveRequestPanelModule } from './leave-request-panel/leave-request-panel.module';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild([
      {
        path: '',
        component: UserRequestPanelComponent,
      },
    ]),
    FormsModule,
    LeaveRequestPanelModule,
    ReactiveFormsModule,
    HttpClientModule,
    DxToastModule,
    DxDataGridModule,
