...
import { SidebarOvertimePaymentComponent } from './sidebar-overtime-payment.component';
...
@NgModule({
  ...
  declarations: [SidebarOvertimePaymentComponent],
  imports: [
    CommonModule,
    RouterModule.forChild([
      {
        path: '',
        component: SidebarOvertimePaymentComponent,
      },
    ]),
    FormsModule,
    ReactiveFormsModule,
...
export class SidebarOvertimePaymentModule { }
